...
All entities are created equal but may later specify new behaviors and capabilities, so the rendering and physics pipelines rely on *duck typing* to determine when and how an entity is handled.
